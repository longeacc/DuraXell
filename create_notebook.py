...
# Section 0
cells.append(nbf.v4.new_markdown_cell("""# DuraXELL : Pipeline Maître et Reproductibilité
**Date** : 6 Mars 2026
...
# Section 1
cells.append(nbf.v4.new_markdown_cell("""## Section 1 : Installation, chargement des données et statistiques descriptives
...
# Section 2
cells.append(nbf.v4.new_markdown_cell("""## Section 2 : Calcul des Métriques ESMO2025 (Te, He, Risk, Freq, Yield)
...
# Section 3
cells.append(nbf.v4.new_markdown_cell("""## Section 3 : Arbre de Décision
...
# Section 5
cells.append(nbf.v4.new_markdown_cell("""## Section 5 : Cascade et Résultats (Performance, Énergie, Explicabilité)
Exécution de l'orchestrateur et calcul du score composite (Front de Pareto)."""))

cells.append(nbf.v4.new_code_cell("""# Chargement des résultats générés par run_full_pipeline_report.py
try:
