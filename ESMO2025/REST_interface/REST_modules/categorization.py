...
def calculate_categorization(
    ...
    ent_cat[current_entity] = [
        element for element in ent_cat[current_entity] if element != "[]"
...
def remove_empty_categories(dict_ent_cat, current_entity):
    dict_ent_cat[current_entity] = [
        category for category in dict_ent_cat[current_entity] if category != "[]"
    ]
    return dict_ent_cat
