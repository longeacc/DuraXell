...
def test_composite_scorer_logic():
    ...
    res_bert = scorer.compute(f1=0.92, method="Transformer", energy_kwh=scorer.MAX_ENERGY_KWH / 2)
...
def test_pareto_analysis():
    ...
    data = [
        ...
        {"Method": "B", "Entity": "E", "F1": 0.8, "Energy_kWh": 0.01}  # Worse F1, Worse Energy (High=Bad), Worse Expl (default 0.1)
    ]
