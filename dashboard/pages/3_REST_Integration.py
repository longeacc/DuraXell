...
def main() -> None:
    ...
    with c1:
        ...
        st.download_button("Télécharger config.json", json_str, file_name="duraxell_config.json", mime="application/json")
    ...
    with c2:
        ...
        if uploaded is not None:
            try:
                ...
                st.success("Configuration importée avec succès ! (Rafraîchissez ou allez dans le Dashboard)")
